...
cli.command('put-car <path>')
  .describe('Upload a CAR file to nft.storage')
  .option('--no-retry', 'Dont try the upload again if it fails')
  .action(putCar)
...
// cli.command('get <cid>')
//   .describe('Fetch and verify files from nft.storage')
